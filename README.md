...
### 简介
这是针对代理软件 **小火箭 Shadowrocket** 的配置文件
...
### 簡介
這是針對代理軟體 **小火箭 Shadowrocket** 的配置檔
...
### Introduction
This is a configuration file for the proxy app **Shadowrocket**

The latest version includes more direct connections to mainland China websites
